...
self.addEventListener('push', (event) => {
  let data = {
    title: 'A gentle nudge from Reverie...',
    body: 'Did anything surprise you today? Take a moment to capture the detail before sleep.',
    url: '/'
  };
  ...
  const options = {
    ...
    vibrate: [100, 50, 100],
    actions: [
      { action: 'open_journal', title: 'Open Notebook' }
    ]
  };
